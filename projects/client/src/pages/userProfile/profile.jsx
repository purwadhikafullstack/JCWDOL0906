...
//             <button
//               onClick={() => logout()}
//               className="px-3 text-red-600 text-left font-bold py-2 w-full border-b-2 border-gray-300 mb-5"
//             >
//               Logout
//             </button>
//           </div>
...
//                 </Button>
//                 <Button
//                   className="w-20 py-3 md:py-0 md:w-44"
//                   color="gray"
...
//                   className="w-20 md:w-44"
//                   color="gray"
//                   onClick={() => navigate("/my-account/history")}
//                 >
//                   Transaction History
//                 </Button>
//               </Button.Group>
...
//               <Dropdown label="My Account" inline={true}>
